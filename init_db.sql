...
CREATE TABLE IF NOT EXISTS "system".bookings (
...
CREATE TABLE IF NOT EXISTS "system".tickets (
    ...
    book_ref CHAR(6) REFERENCES "system".bookings(book_ref),
...
CREATE TABLE IF NOT EXISTS "system".ticket_flights (
    ticket_no CHAR(13) REFERENCES "system".tickets(ticket_no),
...
CREATE TABLE IF NOT EXISTS "system".seats (
    aircraft_code CHAR(3) REFERENCES "system".aircrafts(aircraft_code),
...
CREATE TABLE IF NOT EXISTS "system".boarding_passes (
    ticket_no CHAR(13) REFERENCES "system".tickets(ticket_no),
    flight_id INTEGER REFERENCES "system".flights(flight_id),
